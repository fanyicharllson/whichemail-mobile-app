...
export const ClipboardPrompt: React.FC<ClipboardPromptProps> = ({
  ...
  const handleAuthRequired = () => {
    showToast.error(
      "Login Required",
      "Please login first to save your emails 🔐"
    );
    onDismiss();
        ...
        <View className="bg-white dark:bg-slate-800 rounded-t-3xl p-6 pb-10">
          ...
          <View className="flex-row items-center justify-between mb-4">
            <View className="flex-row items-center gap-2">
              <View className="bg-blue-500 dark:bg-blue-600 w-10 h-10 rounded-full items-center justify-center">
          ...
          {/* Email Display */}
          <View className="bg-blue-50 dark:bg-slate-700 p-4 rounded-xl mb-4 border border-blue-200 dark:border-slate-600">
            ...
            <>
              ...
              <TextInput
                ...
                placeholderTextColor={
                  actualTheme === "dark" ? "#94a3b8" : "#64748b"
                }
                value={serviceName}
