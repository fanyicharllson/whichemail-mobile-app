...
import {
  ...
  useService,
  useToggleFavorite,
} from "@/services/queries/serviceQueries";
...
export default function ServiceDetail() {
  ...
  const { mutate: toggleFavorite, isPending: togglingFavorite } =
    useToggleFavorite();
  ...
  const openWebsite = () => {
    ...
    const url = service.website.match(/^https?:\/\//)
      ? service.website
    ...
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      <View className="bg-indigo-600 dark:bg-indigo-950 pt-14 pb-6 px-6 shadow-lg">
        <View className="flex-row items-center justify-between">
          ...
          <Text
            className="text-white font-bold text-xl flex-1 text-center mx-3"
            numberOfLines={1}
          >
            {service.serviceName}
          </Text>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1">
                ...
                <Text className="text-emerald-700 dark:text-emerald-300 text-sm leading-5">
                  Your password is encrypted with AES-256 encryption and stored
                  securely on your device. Biometric authentication (fingerprint
                  or face ID) is required to view or copy it.
                </Text>
              </View>
            </View>
          </View>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1">
                ...
                <Text className="text-amber-700 dark:text-amber-300 text-sm leading-5">
                  This service doesn&apos;t have a saved password. Tap
                  &quot;Edit&quot; above to add one for better security
                  tracking.
                </Text>
              </View>
            </View>
        ...
        <View className="bg-blue-50 dark:bg-blue-950/30 rounded-3xl p-5 mb-5 border border-blue-200 dark:border-blue-900/50">
          ...
          <View className="space-y-2">
            <Text className="text-blue-700 dark:text-blue-300 text-sm leading-5 mb-2">
              • <Text className="font-semibold">Copy icons (📋)</Text> -
              Instantly copy email or password to clipboard
            </Text>
            <Text className="text-blue-700 dark:text-blue-300 text-sm leading-5 mb-2">
              • <Text className="font-semibold">Eye icon (👁️)</Text> - Toggle
              password visibility (requires biometrics)
            </Text>
            <Text className="text-blue-700 dark:text-blue-300 text-sm leading-5 mb-2">
              • <Text className="font-semibold">Globe icon (🌐)</Text> - Open
              website directly in your browser
            </Text>
            <Text className="text-blue-700 dark:text-blue-300 text-sm leading-5">
              • <Text className="font-semibold">Star icon (⭐)</Text> - Add to
        ...
        <View className="bg-slate-100 dark:bg-slate-900 rounded-3xl p-5 mb-8 border border-slate-200 dark:border-slate-800">
          ...
          <View className="flex-row items-center">
            ...
            <Text className="text-slate-600 dark:text-slate-400 text-xs">
              ...
              at
              {new Date(service.updatedAt).toLocaleTimeString("en-US", {
                hour: "2-digit",
                minute: "2-digit",
              })}
            </Text>
